...
#### 左旋转
当右子树的高度比左子树高度高于1的时候，需要对根节点进行左旋转操作
![uwDP2D.png](https://s2.ax1x.com/2019/10/03/uwDP2D.png)

#### 右旋转
同样，当左子树高度比右子树高度高于1的时候，需要对根节点进行右旋转操作
![uwrnm9.png](https://s2.ax1x.com/2019/10/03/uwrnm9.png)

#### 双旋转
当左子树高度比右子树高度高于1，且左子树的左子树的高度比左子树的右子树的高度矮的时候，需要先处理左子树，先将左子树进行左旋转，再将当前节点进行右旋转即可；反之亦然
